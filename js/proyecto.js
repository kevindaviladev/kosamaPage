...
function cargarDatos() {
  ...
  fetch("./controllers/listar_datos_proyecto_controller.php", {
    ...
    .then(function(resultado) {
      ...
      let descripcion = document.getElementsByClassName("content-proyecto__descripcion")[0];
      ...
      for (i = 0; i < datos.cantidad_fotos; i++) {
        ...
        img.setAttribute(
          "src",
          `./assets/imagenes/${pathProyecto}/${datos.ruta}/${i + 1}.jpg`
        );
      ...
      for (i = 0; i < datos.cantidad_collage; i++) {
        let img = document.createElement("img");
        img.src = `./assets/imagenes/${pathProyecto}/${datos.ruta}/collage_${i +
          1}.jpg`;
